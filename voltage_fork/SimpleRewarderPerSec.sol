...
contract SimpleRewarderPerSec is IRewarder, BoringOwnable, ReentrancyGuard {
    ...
    modifier onlyMCJ() {
        require(
            ...
            'onlyMCJ: only MasterChefVolt can call this function'
        );
        _;
    }
    ...
    constructor(
        ...
        require(
            ...
            'constructor: MasterChefVolt must be a valid contract'
        );
    ...
    function onVoltReward(address _user, uint256 _lpAmount)
        external
        override
        onlyMCJ
        nonReentrant
